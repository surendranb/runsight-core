  ...
  useEffect(() => {
    ...
    const processCallback = async () => {
      try {
        ...
        if (!oauthState) {
          throw new Error('Missing Strava authentication state. Please start the login flow again.');
        }
        ...
        await handleStravaCallback(code, oauthState);
        ...
        const syncResult = await apiClient.startSync({
          timeRange: {
