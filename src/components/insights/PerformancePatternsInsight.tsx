...
export const PerformancePatternsInsight: React.FC<PerformancePatternsInsightProps> = ({ runs }) => {
  ...
  return (
    <Section
      title="Performance Patterns"
      subtitle={`A plain read on whether pace, distance, and consistency are moving in the same direction across ${runs.length} runs.`}
      level={2}
      icon={BarChart3}
      badge={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className={`p-4 border rounded-lg ${getTrendColor(improvementRates.paceImprovement.trend)}`}>
            ...
            <div className="space-y-2">
              ...
              <div className="text-xs opacity-60">
                Support: {getEvidenceCopy(improvementRates.paceImprovement.confidence).label}
              </div>
            </div>
          ...
          <div className={`p-4 border rounded-lg ${getTrendColor(improvementRates.distanceImprovement.trend)}`}>
            ...
            <div className="space-y-2">
              ...
              <div className="text-xs opacity-60">
                Support: {getEvidenceCopy(improvementRates.distanceImprovement.confidence).label}
              </div>
            </div>
            <div className="mt-3 text-sm">
          ...
          <div className={`p-4 border rounded-lg ${getTrendColor(improvementRates.consistencyImprovement.trend)}`}>
            ...
            <div className="space-y-2">
              ...
              <div className="text-xs opacity-60">
                Support: {getEvidenceCopy(improvementRates.consistencyImprovement.confidence).label}
              </div>
            </div>
            <div className="mt-3 text-sm">
