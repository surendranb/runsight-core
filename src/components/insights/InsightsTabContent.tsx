...
const handleInsightAction = () => undefined;
    ...
    <div className="space-y-6">
      ...
      {performanceInsights.length > 0 && (
        <Section
          ...
          subtitle={`The clearest signals about pace, progress, and breakthrough efforts from your last ${runs.length} runs.`}
          level={2}
          icon={TrendingUp}
          badge={{
    ...
    <div className="space-y-6">
      ...
      {trainingInsights.length > 0 && (
        <Section
          ...
          subtitle="What your habits, rhythm, and recovery pattern suggest about the way you are training."
          level={2}
          icon={Calendar}
          badge={{
    ...
    <div className="space-y-6">
      ...
      {environmentInsights.length > 0 && (
        <Section
          ...
          subtitle="Where weather, route, and time of day are helping or hurting the run more than you might think."
          level={2}
          icon={CloudRain}
          badge={{
