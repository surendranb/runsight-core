...
- [ ] Run all migrations in SQL Editor (in order)
  - Historical note: later migrations are retained as safe no-ops
  - [ ] 20250609100000_fresh_start_simple_schema.sql
  - [ ] 20250609110000_add_proper_rls_security.sql
  - [ ] 20250610200000_add_geocoding_columns.sql
  - [ ] 20250717000000_create_goals_table.sql
  - [ ] 20250812000000_add_advanced_training_metrics.sql
- [ ] Copy Project URL and Service Role Key

## Strava API Setup
- [ ] Create app at developers.strava.com after your first Netlify deploy
...
- [ ] Deploy site once to get your final Netlify URL
- [ ] Add all environment variables
- [ ] Trigger a fresh deploy after env setup
...
## Post-Deployment
- [ ] Confirm Strava callback domain matches final Netlify URL
...
- **Hosting:** Netlify
- **APIs:** Strava, OpenWeatherMap

## Security Features
- ✅ Zero frontend credential exposure
- ✅ Private tables are accessed only through Netlify Functions
...
async function runSetup() {
  ...
  try {
    ...
    log('3. Deploy to Netlify once to get your final site URL', 'blue');
    log('4. See docs/DEPLOYMENT.md for the full Supabase + Strava setup flow', 'blue');
    log('5. Check docs/TROUBLESHOOTING.md if you run into issues', 'blue');
