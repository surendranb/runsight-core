...
Thank you for your interest in contributing to RunSight Web. This guide will help you get started with contributing to this source-available running analytics project.

## 🎯 Project Vision

RunSight Web aims to be the best self-hosted running analytics app that:
...
`runsight-web` is the primary development repository for RunSight.

That means:
- product work starts here
- GitHub issues for active work live here
- validated changes are later synced into `runsight-core`
- demo-specific differences belong in `runsight-lite`, not here
